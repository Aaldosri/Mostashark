    ...
    <div className="space-y-6 sm:space-y-8 text-center lg:text-left">
      ...
      <div className="flex justify-center  lg:justify-start">
        ...
        >
          ...
          />
          <span className="mr-1 text-2xl sm:text-sm text-amber-900 tracking-wider">
      ...
      {/* Description */}
      <p className="text-base text-right sm:text-lg text-neutral-700 max-w-xl mx-auto lg:mx-0">
